    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', filer.fields.file.FilerFileField(related_name='djangocms_page_meta_page', blank=True, to='filer.File', help_text='Used if title image is empty.', null=True, on_delete=models.CASCADE)),
                ('og_author', models.ForeignKey(verbose_name='Author account', blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
                ('public_extension', models.OneToOneField(related_name='draft_extension', null=True, editable=False, to='djangocms_page_meta.PageMeta', on_delete=models.CASCADE)),
            ],
            options={
