...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TitleMeta.og_description'
        db.add_column(u'djangocms_page_meta_titlemeta', 'og_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)

        # Adding field 'TitleMeta.twitter_description'
        db.add_column(u'djangocms_page_meta_titlemeta', 'twitter_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=140, blank=True),
                      keep_default=False)

        # Adding field 'TitleMeta.gplus_description'
        db.add_column(u'djangocms_page_meta_titlemeta', 'gplus_description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TitleMeta.og_description'
        db.delete_column(u'djangocms_page_meta_titlemeta', 'og_description')

        # Deleting field 'TitleMeta.twitter_description'
        db.delete_column(u'djangocms_page_meta_titlemeta', 'twitter_description')

        # Deleting field 'TitleMeta.gplus_description'
        db.delete_column(u'djangocms_page_meta_titlemeta', 'gplus_description')
    ...
    models = {
        ...
        u'djangocms_page_meta.pagemeta': {
            ...
            'og_author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['%s']" % settings.AUTH_USER_MODEL, 'null': 'True', 'blank': 'True'}),
        ...
        u'djangocms_page_meta.titlemeta': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'djangocms_page_meta_title'", 'null': 'True', 'to': "orm['filer.File']"}),
        ...
        'filer.file': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owned_files'", 'null': 'True', 'to': u"orm['%s']" % settings.AUTH_USER_MODEL}),
        ...
        'filer.folder': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'filer_owned_folders'", 'null': 'True', 'to': u"orm['%s']" % settings.AUTH_USER_MODEL}),
