...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(blank=True, help_text='Description of the item.', max_length=255, verbose_name='Schemaorg Description'),
        ),
        migrations.AddField(
            model_name='titlemeta',
            name='schemaorg_name',
            field=models.CharField(blank=True, help_text='Name of the item.', max_length=255, verbose_name='Schemaorg Name'),
        ),
