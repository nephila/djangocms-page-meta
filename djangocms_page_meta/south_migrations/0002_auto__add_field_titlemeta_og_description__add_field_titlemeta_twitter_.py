...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('djangocms_page_meta_titlemeta', 'og_description')

        # Deleting field 'TitleMeta.twitter_description'
        db.delete_column('djangocms_page_meta_titlemeta', 'twitter_description')

        # Deleting field 'TitleMeta.gplus_description'
        db.delete_column('djangocms_page_meta_titlemeta', 'gplus_description')
